...
-- map("n", "C-h", "<cmd>wincmd h<CR>", {desc = "go", remap = true})
-- map("n", "C-j", "<cmd>wincmd j<CR>", {desc = "go", remap = true})
-- map("n", "C-k", "<cmd>wincmd k<CR>", {desc = "go", remap = true})
-- map("n", "C-l", "<cmd>wincmd l<CR>", {desc = "go", remap = true})
...
map("n", "<leader>d", "<cmd>DapNew<CR>", {desc = "DapNew", remap = true})
map("n", "<leader>gt", "<cmd>GoTests<CR>", {desc = "Test Generate for One", remap = true})
map("n", "<leader>ga", "<cmd>GoTestsAll<CR>", {desc = "Test ALL Generate", remap = true})
-- tabs
