#!/usr/bin/env python3
"""
Export Claude Code session to markdown when session ends in ~/work/*.
...
AI_MEMORY_DIR = WORK_ROOT / "ai-memory"
...
def main():
    ...
    # Only run for work projects
    if not cwd.startswith(str(WORK_ROOT)):
        sys.exit(0)
